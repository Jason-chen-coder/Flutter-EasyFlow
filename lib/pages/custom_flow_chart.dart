...
class _CustomFlowChartState extends State<CustomFlowChart> {
          ...
          Container(
            ...
            child: FlowChart(
              ...
              onScaleUpdate: (newScale) {
                ...
                debugPrint('Scale updated. statDx: $statDx');
              },
  ...
  void _displayPlusElementMenu(BuildContext context,
      Offset position,
      FlowElement element,) {
      ...
      StarMenu(
        ...
        items: [
          ActionChip(
            ...
            onPressed: () {
              final newElementDx = element.getHandlerPosition(Alignment.bottomCenter).dx;
              final newElementDy = element.getHandlerPosition(Alignment.bottomCenter).dy + dashboard.defaultNodeDistance;
              dashboard.addElementByPlus(element, FlowElement(
          ...
          ActionChip(
            ...
            onPressed: () {
              final newElementDx = element.getHandlerPosition(Alignment.bottomCenter).dx;
              final newElementDy = element.getHandlerPosition(Alignment.bottomCenter).dy + (dashboard.defaultNodeDistance *dashboard.zoomFactor);
              dashboard.addElementByPlus(element, FlowElement(
                position: Offset(newElementDx, newElementDy),
                text: 'Timer Out',
